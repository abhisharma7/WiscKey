...
default: leveldb_test wisckey_test
...
leveldb_test:leveldb_test.cc lab2_common.h $(STATIC_LIBOBJECTS) $(TESTUTIL)
	$(CXX) $(LDFLAGS) $(CXXFLAGS) leveldb_test.cc $(STATIC_LIBOBJECTS) $(TESTUTIL) -o $@ $(LIBS)

wisckey_test:wisckey_test.cc lab2_common.h $(STATIC_LIBOBJECTS) $(TESTUTIL)
	$(CXX) $(LDFLAGS) $(CXXFLAGS) wisckey_test.cc $(STATIC_LIBOBJECTS) $(TESTUTIL) -o $@ $(LIBS)
